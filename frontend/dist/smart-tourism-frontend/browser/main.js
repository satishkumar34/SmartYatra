...
var routes = [
  ...
  },
  {
    ...
    loadChildren: () => import("./auth.routes-SVZAV33Z.js").then((m) => m.authRoutes)
  },
  {
    path: "",
    canActivate: [authGuard],
    loadComponent: () => import("./shell.component-KFR6TUFH.js").then((m) => m.ShellComponent),
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./dashboard.component-5EQVFOQN.js").then((m) => m.DashboardComponent)
      },
      {
        path: "destinations",
        loadComponent: () => import("./destinations-list.component-S22KVS3V.js").then((m) => m.DestinationsListComponent)
      },
      {
        path: "destinations/:id",
        loadComponent: () => import("./destination-detail.component-TVHMFQPU.js").then((m) => m.DestinationDetailComponent)
      },
      {
        path: "hotels",
        loadComponent: () => import("./hotels-list.component-5RCA6UPD.js").then((m) => m.HotelsListComponent)
      },
      {
        path: "hotels/:id",
        loadComponent: () => import("./hotel-detail.component-EFSLQCOW.js").then((m) => m.HotelDetailComponent)
      },
      {
        path: "bookings",
        loadComponent: () => import("./my-bookings.component-XE2HVAKC.js").then((m) => m.MyBookingsComponent)
      },
      {
        path: "bookings/new",
        loadComponent: () => import("./booking-form.component-ZHODUHEY.js").then((m) => m.BookingFormComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./profile.component-PIRZ443R.js").then((m) => m.ProfileComponent)
      },
      {
        path: "admin",
        canActivate: [adminGuard],
        loadChildren: () => import("./admin.routes-6UIIIYBZ.js").then((m) => m.adminRoutes)
      }
    ]
  },
  {
    path: "404",
    loadComponent: () => import("./not-found.component-PJTXOK2C.js").then((m) => m.NotFoundComponent)
  },
  {
    path: "**",
    loadComponent: () => import("./not-found.component-PJTXOK2C.js").then((m) => m.NotFoundComponent)
  ...
  return next(req).pipe(catchError((err) => {
    ...
    if (err.error) {
      if (typeof err.error.detail === "string") {
        ...
        message = err.error.detail.map((e) => e.loc ? `${e.loc.slice(1).join(".")}: ${e.msg}` : e.msg).join(" | ");
...
function ToastContainerComponent_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.icons[toast_r2.type]);
    \u0275\u0275advance(2);
...
var ToastContainerComponent = class _ToastContainerComponent {
  ...
  ngOnInit() {
    this.toastSvc.toasts$.subscribe((toast) => {
      ...
      setTimeout(() => this.dismiss(toast.id), 4e3);
    });
  }
  dismiss(id) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastContainerComponent, selectors: [["app-toast-container"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "toast-container"], [3, "class"], [3, "click"], [1, "toast-icon"], [1, "toast-message"], ["aria-label", "Dismiss", 1, "toast-close"]], template: function ToastContainerComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275repeaterCreate(1, ToastContainerComponent_For_2_Template, 7, 5, "div", 1, _forTrack0);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
